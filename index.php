...
<form method="post" action="success.php">
    ...
    <div class="mb-3">
        ...
        <input required type="text" class="form-control" id="dob" name="dob" value="yyyy-mm-dd">
    </div>
    ...
    <div class="mb-3">
        ...
        <select id="institution" name="institution" class="form-select" aria-label="Select an institution">
            ...
            <option value="<?php echo $r['institution_id']; ?>"><?php echo $r['name']; ?></option>      
            <?php }?>
        </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="tel" class="form-control" id="phone" name="phone" value="" aria-describedby="phoneHelp">
